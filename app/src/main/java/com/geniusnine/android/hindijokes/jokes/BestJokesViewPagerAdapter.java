...
public class BestJokesViewPagerAdapter extends PagerAdapter {
    Context context;
    String[] rank;
    String[] list;
    ...
    public BestJokesViewPagerAdapter(Context context, String[] list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.bestjokestext, container, false);
