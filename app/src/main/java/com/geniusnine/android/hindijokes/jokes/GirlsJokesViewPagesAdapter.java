...
public class GirlsJokesViewPagesAdapter extends PagerAdapter {
    Context context;
    String[] rank;
    String[] list;
    ...
    public GirlsJokesViewPagesAdapter(Context context, String[] list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.girlsjokestext, container, false);
