...
public class CricketViewPagerAdapter extends PagerAdapter {
    Context context;
    String[] rank;
    String[] list;
    ...
    public CricketViewPagerAdapter(Context context, String[] list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.cricketjokestext, container, false);
