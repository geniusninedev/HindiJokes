...
public class FaceBookViewPagerAdapter extends PagerAdapter {
    Context context;
    String[] rank;
    String[] list;
    ...
    public FaceBookViewPagerAdapter(Context context, String[] list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.facebookjokestext, container, false);
