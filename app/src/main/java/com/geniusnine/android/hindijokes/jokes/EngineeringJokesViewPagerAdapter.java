...
public class EngineeringJokesViewPagerAdapter extends PagerAdapter {
    Context context;
    String[] rank;
    String[] list;
    ...
    public EngineeringJokesViewPagerAdapter(Context context, String[] list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.enggjokestext, container, false);
