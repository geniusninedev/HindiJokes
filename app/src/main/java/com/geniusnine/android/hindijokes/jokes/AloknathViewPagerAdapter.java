...
public class AloknathViewPagerAdapter extends PagerAdapter {
    Context context;
    ...
    public AloknathViewPagerAdapter(Context context, String[] list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.aloknathjokestext, container, false);
