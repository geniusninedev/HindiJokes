...
public class StudentJokesViewPagerAdapter extends PagerAdapter {
    Context context;
    String[] rank;
    String[] list;
    ...
    public StudentJokesViewPagerAdapter(Context context, String[] list) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.studentjokestext, container, false);
